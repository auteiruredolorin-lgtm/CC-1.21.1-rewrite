...
public class Mesh {
    ...
    public enum MeshType implements IMeshType {
        ...
        , WOVEN("woven", "Woven Mesh"), DENSE("dense", "Dense Mesh") {
            ...
            @Override
            public int getTintColor(AdvancedAirBlowerBlockEntity te) {
                if (te.heatExchanger != null) return HeatUtil.getColourForTemperature(te.heatExchanger.getTemperatureAsInt());
                return 0xffffffff;
            }
            ...
            public Optional<FanProcessingType> getProcessingType(int temp) {
                return // 100
                temp > 373 ? // 100
                Optional.of(AllFanProcessingTypes.BLASTING) : temp > 323 ? Optional.of(AllFanProcessingTypes.SMOKING) : // 50
                Optional.empty();
            }
    ...
    public interface IMeshType {
        ...
        default Optional<FanProcessingType> getProcessingType(int temp) {
            return Optional.empty();
        }
