...
//        setAir((int) (newPressure * getVolume()));
    ...
    private void disperseAir() {
        ...
        if (connectedAirHandler == null) {
            ...
            // NeoForge 1.21.1: plain Optional, no LazyOptional listener needed
            PNCCapabilities.getAirHandler(blockEntityBelow, Direction.UP).ifPresent(cap -> {
...
//        if (total == maxVolume) copperBacktankBE.sendData();
    ...
    @Override
    public void addPendingAir(int amount) {
        addAir(amount);
    }
}
